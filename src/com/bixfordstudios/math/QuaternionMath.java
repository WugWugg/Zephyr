...
public class QuaternionMath {
	...
	public static Quaternion inverse(Quaternion quaternion)
	{
		...
		return QuaternionMath.divide(conjugate, (norm * norm));
	}
	...
	public static Quaternion divide(Quaternion divisor, Quaternion dividend)
	{
		...
		return QuaternionMath.divide(new Quaternion((dividend.w * divisor.z), -(dividend.x * divisor.y), (dividend.y * divisor.x), -(dividend.z * divisor.w)), dividendNorm);
	}
}
